...
np.save('数据集\\替代数据集\\dataset_train_DVAEout_半MINST.npy', dataset_train)
np.save('数据集\\替代数据集\\dataset_test_DVAEout_半MINST.npy', dataset_test)
...
# 保存合并后的大图片
plt.imsave('数据集\\替代数据集\\替代数据集图像_半MINST.png', mosaic, cmap='gray')

os.system('start ' + '数据集\\替代数据集\\无噪图像_半MINST.png')
os.system('start ' + '数据集\\替代数据集\\替代数据集图像_半MINST.png')
