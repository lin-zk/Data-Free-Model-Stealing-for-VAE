...
(x_train, _), (x_test, __) = fashion_mnist.load_data()
...
plt.axis('off')
plt.imsave('数据集\\替代数据集\\无噪图像_FMINST.png', mosaic, cmap='gray')
...
np.save('数据集\\替代数据集\\dataset_train_DVAEout_FMINST.npy', dataset_train)
np.save('数据集\\替代数据集\\dataset_test_DVAEout_FMINST.npy', dataset_test)
...
# 保存合并后的大图片
plt.imsave('数据集\\替代数据集\\替代数据集图像_FMINST.png', mosaic, cmap='gray')

os.system('start ' + '数据集\\替代数据集\\无噪图像_FMINST.png')
os.system('start ' + '数据集\\替代数据集\\替代数据集图像_FMINST.png')
