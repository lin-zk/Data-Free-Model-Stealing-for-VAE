...
# 保存数据集
np.save('数据集\\原数据集\\mnist_x_train_全MINST.npy', x_train)
np.save('数据集\\原数据集\\mnist_x_test_全MINST.npy', x_test)
...
# 保存合并后的大图片
plt.imsave('数据集\\原数据集\\数据集图像_全MINST.png', mosaic, cmap='gray')
...
vae.save("模型\\受害者模型\\DVAE_受害者模型_全MINST.h5")
...
plt.savefig('模型\\受害者模型\\DVAE_图像结果_全MINST.png')
plt.show()

os.system('start ' + '数据集\\原数据集\\数据集图像_全MINST.png')
