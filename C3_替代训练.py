...
x_train = np.load("数据集\\替代数据集\\dataset_train_DVAEout_FMINST.npy")
x_test = np.load("数据集\\替代数据集\\dataset_test_DVAEout_FMINST.npy")
...
vae.save("模型\\替代模型\\DVAE_替代模型_FMINST.h5")
...
plt.savefig('模型\\替代模型\\DVAE_图像结果_FMINST.png')
plt.show()
