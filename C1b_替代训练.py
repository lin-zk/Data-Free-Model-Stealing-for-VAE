...
x_train = np.load("数据集\\替代数据集\\dataset_train_DVAEout_加强噪声.npy")
x_test = np.load("数据集\\替代数据集\\dataset_test_DVAEout_加强噪声.npy")
...
vae.save("模型\\替代模型\\DVAE_替代模型_加强噪声.h5")
...
plt.savefig('模型\\替代模型\\DVAE_图像结果_加强噪声.png')
plt.show()
